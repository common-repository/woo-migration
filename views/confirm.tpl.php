...
$notice = $this->_notice;
?>
<form action="" method="post" id="form-confirm" class="">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-wrapper">
                <div class="group-title">Source Cart</div>
                ...
                <div class="group-title">Entities</div>
                <div class="form-group">
                    <?php foreach($notice['config']['import'] as $import_type => $import_val): ?>
                        <?php if($import_val): ?>
                            <div>- <?php echo ucfirst($import_type); ?></div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="lecm-footer">
            <div id="form-confirm-loading" class="lecm-loading">Processing ...</div>
            <div id="form-confirm-submit" class="lecm-submit">Next &raquo;</div>
        </div>
        <a id="form-confirm-back" class="lecm-back">&laquo; Back to previous step</a>
        <div class="cls"></div>
    </div>
</form>