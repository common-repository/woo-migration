    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div style="margin: 10px 0;">
                ...
                <p>Entity limit:
                    <strong><?php echo is_int($notice['config']['limit']) ? $notice['config']['limit'] : ucfirst($notice['config']['limit']); ?></strong>
                </p>
            </div>
            <ul id="lecm-tips">
                ...
                <?php if ($notice['config']['import']['taxes']): ?>
                    <div class="form-group" id="process-taxes">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['taxes']['imported']; ?>
                                /<?php echo $notice['taxes']['total']; ?>,
                                Errors: <?php echo $notice['taxes']['error']; ?></div>
                        </div>
                ...
                <?php if ($notice['config']['import']['manufacturers']): ?>
                    <div class="form-group" id="process-manufacturers">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['manufacturers']['imported']; ?>
                                /<?php echo $notice['manufacturers']['total']; ?>,
                                Errors: <?php echo $notice['manufacturers']['error']; ?></div>
                        </div>
                        <div class="try-import cls">
                ...
                <?php if ($notice['config']['import']['categories']): ?>
                    <div class="form-group" id="process-categories">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['categories']['imported']; ?>
                                /<?php echo $notice['categories']['total']; ?>,
                                Errors: <?php echo $notice['categories']['error']; ?></div>
                        </div>
                        <div class="try-import cls">
                ...
                <?php if ($notice['config']['import']['products']): ?>
                    <div class="form-group" id="process-products">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['products']['imported']; ?>
                                /<?php echo $notice['products']['total']; ?>,
                                Errors: <?php echo $notice['products']['error']; ?></div>
                        </div>
                        <div class="try-import cls">
                ...
                <?php if ($notice['config']['import']['customers']): ?>
                    <div class="form-group" id="process-customers">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['customers']['imported']; ?>
                                /<?php echo $notice['customers']['total']; ?>,
                                Errors: <?php echo $notice['customers']['error']; ?></div>
                        </div>
                        <div class="try-import cls">
                ...
                <?php if ($notice['config']['import']['orders']): ?>
                    <div class="form-group" id="process-orders">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['orders']['imported']; ?>
                                /<?php echo $notice['orders']['total']; ?>,
                                Errors: <?php echo $notice['orders']['error']; ?></div>
                        </div>
                        <div class="try-import cls">
                    ...
                    <div class="form-group" id="process-comments">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="console-log">Imported: <?php echo $notice['comments']['imported']; ?>
                                /<?php echo $notice['comments']['total']; ?>,
