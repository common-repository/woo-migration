WOOCOMMERCE CONNECTOR INSTALLATION GUIDE

Notice: this does not apply for Shopify, Bigcommerce and Volusion stores.

1. Download the connector: http://demo3.litextension.com/woocommerce_connector.zip

2. Upload the whole folder to your Source store root directory, so that we can get this exact link:
http://your-store.com/woocommerce_connector/connector.php
(If your store is put in a inner directory, please just make sure to upload the file to correct location accordingly, for example, your source store is located at http://your-domain.com/shop/, please upload the connector at http://your-domain.com/shop/woocommerce_connector/connector.php )
You can test this link by entering it into your browser, if you have placed the file correctly, you should see a message:
"Connector installed"

3. Check your PHP version by entering this page: http://your-store.com/woocommerce_connector/info.php
...
5. Log on woocommerce store with Cart Migration module installed, enter the following info in migration form:
...
WOOCOMMERCE CART MIGRATION FULL GUIDE

http://litextension.com/docs/Woocommerce_Migration_Tool_Userguide.pdf
