            ...
            function importPostCat() {
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if (response.result === 'success') {
                            showProcessBar(settings.processPostCat, response.postCat.total, response.postCat.imported, response.postCat.error, response.postCat.point);
            ...
            function importPosts() {
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if (response.result === 'success') {
                            showProcessBar(settings.processPosts, response.posts.total, response.posts.imported, response.posts.error, response.posts.point);
            ...
            function importComments() {
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if (response.result === 'success') {
                            showProcessBar(settings.processComments, response.comments.total, response.comments.imported, response.comments.error, response.comments.point);
                            deleteLecmCookie();
