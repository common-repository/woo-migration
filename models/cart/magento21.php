...
class LeCaMgCartMagento21 extends LeCaMgCart
{
    public function displayConfig(){
        ...
        $default_config = $this->getConnectorData($this->getUrlConnector('query'), array(
            ...
            'query' => serialize(array(
                "core_store" => "SELECT * FROM _DBPRF_store WHERE store_id != 0",
...
//                }
        ...
        $allow = array ('select', 'text', 'textarea', 'boolean');
    ...
    protected function _getOrdersExtraQuery($orders){
        ...
        $ext_query = array(
            'sales_flat_order_item' => "SELECT * FROM _DBPRF_sales_order_item WHERE parent_item_id IS NULL AND order_id IN {$order_id_query}",
