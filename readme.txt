=== LitExtension: Migrate to WooCommerce ===
Contributors: LitExtension
Donate link: 
Tags: magento to woocommerce migration, opencart to woocommerce migration, shopify to woocommerce migration, bigcommerce to woocommerce migration, virtuemart to woocommerce migration
...
This plugin allows you to migrate your products, orders, customers and other data from your store to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers and other data from your store to WooCommerce automatically. 
...
 
== ADDITIONAL FEATURES ==
* No Downtime: Data is migrated with no downtime for your current your store store
...
* Migrate Recent Data: You have just finished a full migration, after that your store is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from your store to WooCommerce, NO third party involved
...
<iframe width="611" height="340" src="https://www.youtube.com/embed/otaxYWIYRKM" frameborder="0" allowfullscreen></iframe>
...
== Installation ==
1. Upload the `cscartwoocommercemigration` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to the Plugins -> WooCommerce Migration


== Documentation and Support ==
Please [Contact LitExtension](http://litextension.com/contacts/) if you have any questions about migration to WooCommerce.
...
The plugin is free to download and install however you will have to pay for the full migration.
